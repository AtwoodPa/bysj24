<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['vaccine:district:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['vaccine:district:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['vaccine:district:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['vaccine:district:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="districtList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="" align="center" prop="code" />
...
<script>
import { listDistrict, getDistrict, delDistrict, addDistrict, updateDistrict } from "@/api/vaccine/district";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除省市区号编号为"' + ids + '"的数据项？').then(() => {
        this.loading = true;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('vaccine/district/export', {
        ...this.queryParams
