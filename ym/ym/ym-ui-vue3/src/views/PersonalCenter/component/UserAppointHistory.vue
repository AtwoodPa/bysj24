<template>
  <div >
    <el-table v-loading="loading" :data="appointList" >
      ...
      <el-table-column label="ID" show-overflow-tooltip align="center" prop="id" v-if="true"/>
      <el-table-column width="110px" label="预约用户信息" align="center" prop="userName" />
      <el-table-column label="预约日期" align="center" prop="appointDate" width="120">
      ...
      <el-table-column width="220px" label="接种站点信息" align="center" prop="inoculateSiteName" />
      <el-table-column width="120px" label="疫苗信息" align="center" prop="vaccineName" />
      <el-table-column label="第几针" align="center" prop="whichPin" />
      <el-table-column width="120px" label="操作" align="center" fixed="right" class-name="small-padding fixed-width">
        <template #default="scope">
...
<script setup name="UserAppointHistory">
