<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['vaccine:appointment:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['vaccine:appointment:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['vaccine:appointment:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['vaccine:appointment:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="appointmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="" align="center" prop="appointmentId" v-if="true"/>
...
<script>
import { listAppointment, getAppointment, delAppointment, addAppointment, updateAppointment } from "@/api/vaccine/appointment";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除疫苗预约编号为"' + appointmentIds + '"的数据项？').then(() => {
        this.loading = true;
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('vaccine/appointment/export', {
        ...this.queryParams
