package com.house.generator.controller;
...
import com.house.generator.service.IGenTableService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"house.zip\"");
