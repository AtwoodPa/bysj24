...
UPDATE [sys_oss_config] SET [access_key] = N'house', [secret_key] = N'house123', [endpoint] = N'127.0.0.1:9000' WHERE [oss_config_id] = 1
GO
...
INSERT INTO [sys_oss_config] ([oss_config_id], [config_key], [access_key], [secret_key], [bucket_name], [prefix], [endpoint], [domain], [is_https], [region], [status], [ext1], [create_by], [create_time], [update_by], [update_time], [remark]) VALUES (N'5', N'image',  N'house', N'house123', N'house', N'image', N'127.0.0.1:9000', N'',N'N', N'', N'1', N'', N'admin', getdate(), N'admin', getdate(), NULL)
GO
