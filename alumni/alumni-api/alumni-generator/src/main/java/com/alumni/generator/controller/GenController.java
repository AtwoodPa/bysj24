package com.alumni.generator.controller;
...
import com.alumni.generator.service.IGenTableService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=\"alumni.zip\"");
